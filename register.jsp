				...
				<div class="row justify-content-center">
					<div class="col-md-7 mb-5" data-aos="fade">
						...
						<form action="UserServlet" method="post" class="p-5 bg-white">
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label class="text-black" for="subject">Username</label> <input
							...
							<div class="row form-group">
								<div class="col-md-12">
									<label class="text-black" for="subject">Password</label> <input
										type="password" name="pass" id="subject" class="form-control">
								</div>
							</div>

							<div class="row form-group">
								<div class="col-md-12">
									<label class="text-black" for="subject">Re-type
										Password</label> <input type="password" id="subject"
										class="form-control">
								</div>
							</div>
