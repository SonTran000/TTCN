...
<body>
	...
	<%
		...
		if (request.getParameter("post") != null) {
			...
			p = pd.getPost(Integer.parseInt(idpost));
		}
	%>
	<div class="site-wrap">
							...
							<div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
								<div class="h-entry">
									...
									<h2 class="font-size-regular">
										<a href="#" class="text-black"><%=p.gettitle() %></a>
									</h2>
									<div class="meta mb-3">
										by Mark Spiker<span class="mx-1">&bullet;</span> <%=p.getdateup() %>
										<span class="mx-1">&bullet;</span> <a href="#">News</a>
									</div>
									<p><%=p.getcontent() %></p>
								</div>
							</div>
					...
					<div class="col-md-3 ml-auto">
						...
						<div class="mb-5">
							...
							<ul class="list-unstyled">
								...
								<li class="mb-2"><a href="#">Quaerat rerum voluptatibus
										veritatis</a></li>
								<li class="mb-2"><a href="#">Maiores sapiente veritatis
										reprehenderit</a></li>
